      ...
      <section className="container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              I am a certified Level 4 Integrative Psychotherapist (CPCAB, UK), Reiki Healer,, Addiction Therapist, EFT practitioner and a recognized hypnotherapist by the National Guild of Hypnotists, USA. As the founder of Mind-Mechanics and a Mental Health Therapist at doctHERs, I have successfully provided therapy to over 1950 clients, offering personalized healing solutions for individuals, couples, and rehabilitation cases.
            </p>
          </motion.div>
        </div>
      </section>
