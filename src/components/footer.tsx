    ...
    <footer className="border-t">
      <div className="container py-8">
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          ...
          <p>Developed by <a href="https://www.galaxiumdigital.app/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Galaxium Digital</a></p>
        </div>
      </div>
    </footer>
  )
