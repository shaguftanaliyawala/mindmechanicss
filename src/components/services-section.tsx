...
const services = [
  ...
  },
  {
    ...
    link: "/services",
    bgImage: "/corp.jpeg?height=400&width=600", // Replace with actual image path
  },
  {
    icon: Lightbulb,
    ...
    format: "Workshops & private sessions.",
    link: "/services",
    bgImage: "/mindful.png?height=400&width=600", // Replace with actual image path
  },
  {
    icon: Compass,
    title: "Hypnotherapy",
    ...
    link: "/services",
    bgImage: "/reiki.jpg?height=400&width=600", // Replace with actual image path
  },
  {
    icon: Zap,
    title: "EFT Tapping",
  ...
  },
  {
    ...
    link: "/services",
    bgImage: "/numerology-concept-composition.jpg?height=400&width=600", // Replace with actual image path
  },
  {
    icon: Gem,
  ...
  },
  {
    ...
    link: "/services",
    bgImage: "/add.jpg?height=400&width=600", // Replace with actual image path
  },
  {
    icon: Baby,
    title: "Child Therapy",
    ...
    link: "/services",
    bgImage: "/child.jpg?height=400&width=600", // Replace with actual image path
  },
]
